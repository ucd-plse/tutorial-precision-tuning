...
RUN sudo apt-get install time -y
...
# Copy the precimonious exercises into the container at /root/precimonious
COPY precimonious-exercise/ /root/precimonious/exercise/
COPY precimonious-exercise-2/ /root/precimonious/exercise-2/
...
# Copy the hifptuner exercises into the contianer at /root/HiFPTuner
COPY hifptuner-exercise/ /root/HiFPTuner/exercise/
COPY hifptuner-exercise-2/ /root/HiFPTuner/exercise-2/
COPY README /root/ 
