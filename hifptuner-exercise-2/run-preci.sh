...
# run analysis
$HIFP_PRECI/scripts/dd2.py $1.bc search_$1.json config_$1.json

# print and save results
rm -rf results-preci; mkdir results-preci
...
mv VALID*.json INVALID*.json FAIL*.json dd2*.json config_temp.json log.cov log.dd log.txt output.txt results-preci/ 2>/dev/null
